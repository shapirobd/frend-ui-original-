...
import * as $ from "jquery"; // import Button from "../Form/Button";
...
const Accordion = ({
  ...
  const toggleCollapsed = () => setCollapsed(!collapsed); // const toggleHidden = () => setHidden(!hidden);
  ...
  console.log(children); // useEffect(() => toggleHidden(), [collapsed]);

  return /*#__PURE__*/React.createElement("div", {
    className: "Accordion" + (bg ? ` bg-${bg}` : "") + (disabled ? " disabled" : "")
  }, children);
};
